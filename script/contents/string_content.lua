string_content = {}
string_content.__index = string_content

function string_content.new()
    local self = setmetatable({}, string_content)
...
# YOU CAN USE THIS FILE AS A TEMPLATE AND MODIFY IT AS NEEDED.
    ...
    self._TOOLS_NAME_NOUN = "profile"
    self._TOOLS_NAME_GERUND = "profiling"

    -- Setup metatable for dynamic concatenation
    setmetatable(self, {
        __index = function(t, k)
            -- Tools name string
            if k == "_TOOLS_NAME_UPPER" then              return string.upper(t._TOOLS_NAME)
            ...
            elseif k == "_PLG_CALLBACK_FUNC" then             return t._DOMAIN.."_callback"
            elseif k == "_PLG_CALLBACK_FUNC_DECL" then        return "void "..t._PLG_CALLBACK_FUNC.."("..t._CB_ARGS..")" 
