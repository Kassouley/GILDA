...
# YOU CAN USE THIS FILE AS A TEMPLATE AND MODIFY IT AS NEEDED.
    ...
    setmetatable(self, {
        __index = function(table, key)
            ...
            elseif key == "_API_DATA_S" then                return table._CURRENT_DOMAIN.."_api_activity_s"
            elseif key == "_API_DATA_T" then                return table._CURRENT_DOMAIN.."_api_activity_t"
            ...
            elseif key == "_CB_ARGS" then                   return "bool is_enter, const "..table._API_DATA_T.."* activity"
