...
]]..S:STRING("I_START_FUNC_DECL")..[[ 
{
    ...
    lc->current_phase = ]]..S:STRING("TOOLS_NAME|upper")..[[_IN_CONSTRUCTOR_PHASE;
...
]]..S:STRING("I_STOP_FUNC_DECL")..[[ 
{
    ...
    lc->current_phase = ]]..S:STRING("TOOLS_NAME|upper")..[[_IN_TOOL_FINI_PHASE;
